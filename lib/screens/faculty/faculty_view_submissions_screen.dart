...
/// Shows assignments for a selected subject
      ...
      body: FutureBuilder<List<Map<String, dynamic>>>(
        ...
        builder: (context, snap) {
          ...
          for (final a in assignments) {
            ...
            if (due == null || due.isAfter(now) || due.isAtSameMomentAs(now)) {
              ongoing.add(a);
            } else {
              completed.add(a);
            }
                ...
                builder: (context, snap) {
                  ...
                  return ListView.builder(
                    ...
                    itemBuilder: (context, idx) {
                      final sub = subs[idx];
                      final sid = sub['id'];
                      //final studentName = sub['student_name'] ?? 'Unknown';
                                ...
                                children: [
                                  Expanded(
                                    child: TextField(
                                      ...
                                      enabled:
                                          !isMarksSaved, // disabled if saved
